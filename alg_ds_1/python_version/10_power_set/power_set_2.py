...
# Рефлексия
# Динамическая хэш-таблица - сначала выделил новый массив, а потом через put и хэш-функцию раскладывал значения
# итеративно. В целом ничего сложного.
# Соль сделал статическую для отдельно взятой таблицы, поскольку чтобы полуить индекс нужно знать соль. Но
# если речь идет о хранении паролей, то действительно никакой проблемы с динамической солью нет.