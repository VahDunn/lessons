...
# Этот тест я намеренно сделал достаточно щадящим. Причем, за это еще и пришлось с ревьюером повоевать.
...
# Еще одно изменение - к существовавшим ранее пользовательским хинтам добавились
# хинты системные.
...
# тесты для точного и конкретного, но все же намеренно жесткого бизнес-правила. И в первые итерации было действительно
